...
def print_state():
    ...
    if accuracy >= 80 and booking_manager.routing_accuracy["special_handling_applied"] >= 2 and booking_manager.routing_accuracy["urgent_requests_identified_by_llm"] >=1 :
        print("\n✅ System demonstrated effective routing, special case handling, and urgency identification!")
    else:
        print("\n⚠️ System may need improvement in routing, special case handling, or urgency processing.")
    print("=" * 80)
